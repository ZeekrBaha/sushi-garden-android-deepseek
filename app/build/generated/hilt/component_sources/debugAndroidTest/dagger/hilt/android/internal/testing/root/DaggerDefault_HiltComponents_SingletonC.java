...
import com.baha.sushigarden.AuthFlowTest;
import com.baha.sushigarden.CartFlowTest;
import com.baha.sushigarden.CartFlowTest_MembersInjector;
import com.baha.sushigarden.CatalogFlowTest;
import com.baha.sushigarden.CheckoutFlowTest;
import com.baha.sushigarden.HiltTestActivity;
import com.baha.sushigarden.MainActivity;
import com.baha.sushigarden.OrdersFlowTest;
import com.baha.sushigarden.ProductDetailFlowTest;
import com.baha.sushigarden.ProfileFlowTest;
import com.baha.sushigarden.PromotionsFlowTest;
import com.baha.sushigarden.SushiGardenApp;
import com.baha.sushigarden.TestHiltModule_ProvideAuthServiceFactory;
import com.baha.sushigarden.TestHiltModule_ProvideCartServiceFactory;
import com.baha.sushigarden.TestHiltModule_ProvideDatabaseFactory;
import com.baha.sushigarden.TestHiltModule_ProvideMenuRepositoryFactory;
import com.baha.sushigarden.TestHiltModule_ProvideOrderDaoFactory;
import com.baha.sushigarden.TrackingFlowTest;
...
public final class DaggerDefault_HiltComponents_SingletonC {
  ...
  private static final class SingletonCImpl extends Default_HiltComponents.SingletonC {
    ...
    private OrderDao orderDao() {
      return TestHiltModule_ProvideOrderDaoFactory.provideOrderDao(provideDatabaseProvider.get());
    }

    @SuppressWarnings("unchecked")
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      this.provideCartServiceProvider = DoubleCheck.provider(new SwitchingProvider<CartService>(singletonCImpl, 0));
    ...
    @Override
    public void injectTest(AuthFlowTest arg0) {
    }

    @Override
    public void injectTest(CartFlowTest arg0) {
      injectCartFlowTest(arg0);
    }

    @Override
    public void injectTest(CatalogFlowTest arg0) {
    }

    @Override
    public void injectTest(CheckoutFlowTest arg0) {
    }

    @Override
    public void injectTest(OrdersFlowTest arg0) {
    }

    @Override
    public void injectTest(ProductDetailFlowTest arg0) {
    }

    @Override
    public void injectTest(ProfileFlowTest arg0) {
    }

    @Override
    public void injectTest(PromotionsFlowTest arg0) {
    }

    @Override
    public void injectTest(TrackingFlowTest arg0) {
    }
    ...
    private CartFlowTest injectCartFlowTest(CartFlowTest instance) {
      CartFlowTest_MembersInjector.injectCartService(instance, provideCartServiceProvider.get());
      return instance;
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.baha.sushigarden.data.services.cart.CartService 
          return (T) TestHiltModule_ProvideCartServiceFactory.provideCartService();

          case 1: // com.baha.sushigarden.data.services.auth.AuthService 
          return (T) TestHiltModule_ProvideAuthServiceFactory.provideAuthService();

          case 2: // com.baha.sushigarden.data.services.catalog.MenuRepository 
          return (T) TestHiltModule_ProvideMenuRepositoryFactory.provideMenuRepository();

          case 3: // com.baha.sushigarden.data.services.orders.SushiGardenDatabase 
          return (T) TestHiltModule_ProvideDatabaseFactory.provideDatabase(ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule));
