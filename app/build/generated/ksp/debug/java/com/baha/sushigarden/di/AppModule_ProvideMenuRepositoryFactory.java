...
public final class AppModule_ProvideMenuRepositoryFactory implements Factory<MenuRepository> {
  ...
  public static AppModule_ProvideMenuRepositoryFactory create() {
    return InstanceHolder.INSTANCE;
  }

  public static MenuRepository provideMenuRepository() {
    return Preconditions.checkNotNullFromProvides(AppModule.INSTANCE.provideMenuRepository());
  }

  private static final class InstanceHolder {
    private static final AppModule_ProvideMenuRepositoryFactory INSTANCE = new AppModule_ProvideMenuRepositoryFactory();
  }
}
